                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="https://uat.esewa.com.np/epay/main" method="POST">
                            ...
                            <input value="http://localhost/DVS/admin/login_system/payment_success.php" type="hidden" name="su">
                            <input value="http://localhost/DVS/admin/login_system/payment_failure.php" type="hidden" name="fu">
