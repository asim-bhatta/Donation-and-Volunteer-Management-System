   ...
   <body>
      ...
      <div class="header_section">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
               ...
               <button class="donate_btn"><a href="admin/login_system/donation_payment.php">Donate Now</a></button>
               </form>
            </div>
         </nav>
      <!-- header section end -->
                  ...
                  <div class="carousel-item active">
                     <div class="row">
                        ...
                        <div class="container">
                           ...
                           <h1 class="banner_taital">Welcome Donor!</h1>
               ...
               <div class="row">
                  ...
                  <div class="col-md-6">
                     ...
                     <div class="donate_btn_main">
                        ...
                        <div class="readmore_btn_1"><a href="admin/login_system/donation_payment.php">Donate Now</a></div>
                     </div>
                  </div>
               </div>
            </div>
